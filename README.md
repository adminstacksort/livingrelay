...
- `ANTHROPIC_API_KEY` for primary AI vendor discovery. Optional fallbacks: `OPENAI_API_KEY`, `GOOGLE_AI_STUDIO_API_KEY`/`GOOGLE_GEMINI_API_KEY`, `GOOGLE_PLACES_API_KEY`, and `OPEN_WEB_SEARCH_API_URL`.
